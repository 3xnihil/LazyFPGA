...
export CONTAINER_SETUP_DIR="/usr/local/bin/intel-setup"
...
export Q_INSTALLER_DIR="${IMAGE_BUILD_CONTEXT}/intel-setup"
export Q_INSTALLER_SCRIPT_NAME="qinst.sh"
export Q_INSTALLER_SCRIPT="${CONTAINER_SETUP_DIR}/${Q_INSTALLER_SCRIPT_NAME}"
...
export Q_INSTALLER_WRAPPER="/usr/local/bin/${Q_INSTALLER_WRAPPER_NAME}"
export Q_DIRNAME="intelFPGA_lite"
export Q_ROOTDIR="${CONTAINER_HOME}/${Q_DIRNAME}"
export Q_SETUP_DIR="${CONTAINER_HOME}/setup"
export LM_LICENSE_FILE=""
export FF_SETUP_DONE="${CONTAINER_HOME}/.setup-done"
export FF_SETUP_FAILED="${CONTAINER_HOME}/.setup-failed"
...
export QUARTUS_MIME="${LOCAL_MIMEDIR}/packages/application-x-qpf.xml"
export QUESTA_MIME="${LOCAL_MIMEDIR}/packages/application-x-mpf.xml"
